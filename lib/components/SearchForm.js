...
SearchForm.prototype.render = function () {
  ...
  var fromFormGroup = new FormGroup({
    label: { for: 'from', content: 'From location' },
    input: {
      type: "text",
      name: "from",
  ...
  el.firstChild.appendChild(fromFormGroup.render());

  var toFormGroup = new FormGroup({
    label: { for: 'to', content: 'To location' },
    input: {
      type: "text",
      name: "to",
      value: self.props.to,
  ...
  el.firstChild.appendChild(toFormGroup.render());

  var travelDateFormGroup = new FormGroup({
    label: { for: 'travel_date', content: 'Travel date' },
    input: {
      type: "text",
      name: "travel_date",
  ...
  el.firstChild.appendChild(travelDateFormGroup.render());
  ...
  el.firstChild.appendChild(submitButtonFormGroup.render());

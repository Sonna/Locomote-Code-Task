...
// FlightAPI.prototype.search = function (params, callback) {
  ...
  this.asyncSearchPreamble(params).then(function (searchData) {
    ...
    const flightSearchesWithAirlineCodes = results[1];
    ...
    const searchData = results[0];
    const flightSearchesWithFromAirports = results[1];
    ...
    const searchData = results[0];
    const flightSearchesWithToAirports = results[1];
